...
For example:
> python3 test_update_landing_page.py 10.4124/R90R967372K https://example.com/files/R90R967372K     
...
## test_batch_lp_update.py [FILE_CONTAINING_SHORT_DOIS] [NEW_SERVER_NAME]
